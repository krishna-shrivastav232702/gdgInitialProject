    ...
    return (
        <div className='mt-16 flex items-center justify-center bg-darkBlue min-h-screen'>
            <div className='bg-white rounded-lg shadow-lg overflow-hidden flex w-full max-w-4xl'>
                <img src={event.imageUrl} alt={event.title} className='h-96 full object-contain' />
                <div className='p-6 flex-1'>
                    <h1 className='text-3xl font-bold text-gray-800 mb-2'>{event.title}</h1>
                    <h3 className='text-xl text-black font-bold mb-6 mt-4'>Description: <span className='text-lg '>{event.description}</span></h3>
                    <h2 className='text-md font-semibold text-gray-700 mb-2'>Location: <span className='font-bold'>{event.location}</span></h2>
                    <h2 className='text-md font-semibold text-gray-700 mb-2'>Date: <span className='font-bold'>{event.date}</span></h2>
